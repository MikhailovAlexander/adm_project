...
-- object: clent_person_fk | type: CONSTRAINT --
-- ALTER TABLE public.client DROP CONSTRAINT IF EXISTS clent_person_fk CASCADE;
ALTER TABLE public.client ADD CONSTRAINT clent_person_fk FOREIGN KEY (person_id)
