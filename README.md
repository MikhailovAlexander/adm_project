...
## 7. Database deploying
## 8. Master data building
The Russian software [Loginom](https://loginom.ru/) is used to create the Master data about the clients of the equestrian center. The chosen program allows to configure the connection to the databases and then check the selected tables for duplicates and contradictions. Upon completion of the merging and cleaning the input data imported from the two databases, the Ьaster data is automatically exported to the database.
